window.addEventListener('load', function() {
    ...
    const SubscriptionProductSettings = {
        checkBox: document.getElementById('ssmfw_subscription_product'),
        subscriptionTab: document.getElementsByClassName('ssmfw_subscription_tab_options')[0],
        selectedRadio: document.querySelector('input[type=radio][name=smart_subscriptions_recurring_expiry]:checked'),
        ...
        init: function() {
            ...
            let expiryRadio = document.getElementsByName('smart_subscriptions_recurring_expiry');
